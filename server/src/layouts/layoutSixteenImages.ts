/**
 * Returns positions for exactly 16 images per page, arranged in
 * 4 columns x 4 rows, with configurable spacing between images.
 *
 ...
 * @returns An array of slots (x, y, width, height) for 16 images.
 */
export function layoutSixteenImages(
    pageWidth: number,
    pageHeight: number,
    margin: number
