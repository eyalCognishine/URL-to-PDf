import generatePdfFromImages from './generatePdf';
...
const outputPath = path.join('C:', 'Users', 'User', 'Desktop', 'output.pdf');

export function runPdfGenerator(): void {
  ...
  rl.question('Enter your choice (1-4): ', (answer) => {
    ...
    generatePdfFromImages(imageUrls, imagesPerPage, outputPath)
      .then(() => {
