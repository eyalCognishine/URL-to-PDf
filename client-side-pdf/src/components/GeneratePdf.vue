  ...
  <div class="pdf-container">
    ...
    <div class="input-block">
      ...
      <select v-model.number="layoutOption">
        ...
        <option :value="4">4 images on 1 page (2x2)</option>
        <option :value="8">8 images on 1 page (4x2)</option>
        <option :value="12">12 images on 1 page (4x3)</option>
        <option :value="16">16 images on 1 page (4x4)</option>
        <option :value="20">20 images on 1 page (5x5)</option>
      </select>
    </div>
